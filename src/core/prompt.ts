...
- "not_found": nothing in the evidence answers or decides the question, including questions about models, products or specifications the documents never mention. A question that a stated rule, range or limit decides is not "not_found": answer it with basis "inferred". Say plainly that the uploaded documents do not specify it. If a line is closely related and genuinely useful — the nearest specification, or the rule that governs the topic — add one short sentence about it after saying it is not specified, and put its id in "related". Never present related information as the answer. Leave "related" empty when nothing helps.
...
basis: "inferred" only for an answered or conflict answer that follows from a rule, range, limit, condition or definition; otherwise "stated".
